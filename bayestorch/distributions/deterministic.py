...
from torch.distributions import Distribution, constraints, register_kl

from bayestorch.distributions.finite import Finite
...
class Deterministic(Finite):
    """Distribution that returns a single deterministic
